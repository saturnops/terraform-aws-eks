...
```hcl
module "eks" {
  source = "gitlab.com/saturnops/sal/terraform/aws/eks?ref=v1.0.0"
...
module "managed_node_group_app" {
    source = "gitlab.com/saturnops/sal/terraform/aws/eks//node-groups/managed-nodegroup?ref=v1.0.0"
