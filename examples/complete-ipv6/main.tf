...
module "vpc" {
  source                                          = "git::https://github.com/yuvraj-saturnops1/terraform-aws-vpc.git"
  environment                                     = local.environment
  name                                            = local.name
...
module "eks" {
  source                               = "git::https://github.com/yuvraj-saturnops1/terraform-aws-eks.git"
...
module "managed_node_group_production" {
  source                 = "git::https://github.com/yuvraj-saturnops/terraform-aws-eks.git//modules/managed-nodegroup?ref=feature/ipv6-enable"
